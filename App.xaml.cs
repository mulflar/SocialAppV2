...
namespace SocialAppV2
{
    public partial class App : Application
    {
        ...
        {
            if (IsolatedStorageSettings.ApplicationSettings.Contains("Uuid"))
            {
            }
            else
            {
                String Uuid = Guid.NewGuid().ToString();
                IsolatedStorageSettings.ApplicationSettings["Uuid"] = Uuid;
        ...
        {
            ((MainPage)(((System.Windows.Controls.ContentControl)(App.RootFrame)).Content)).peticionperfil();
        }
        ...
        {
            (Application.Current.RootVisual as PhoneApplicationFrame).Navigate(new Uri("/seccmapa/traseramapa.xaml", UriKind.Relative));
        }
        private void ApplicationBarIconButton_Click12(object sender, EventArgs e)
        {
            ((MainPage)(((System.Windows.Controls.ContentControl)(App.RootFrame)).Content)).launchpreferencias();
        }
        private void ApplicationBarIconButton_Click13(object sender, EventArgs e)
        {
            ((MainPage)(((System.Windows.Controls.ContentControl)(App.RootFrame)).Content)).track();
        }
